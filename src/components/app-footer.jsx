        ...
        <Navbar sticky="bottom" expand="sm" bg="light" variant="light" >
          ...
          <Navbar.Collapse className="justify-content-end">
            <Nav className="justify-content-end">
              <Nav.Item>
                <Button onClick={() => this.setModalShow(true)} variant="link" bottom="true" ><FontAwesomeIcon icon={faQuestion} color="#1551d1e3" /></Button>
              </Nav.Item>
              <Nav.Item>
                <Button title="Reset the application state" variant="link" bottom="true" onClick={() => this.resetAppState()}><FontAwesomeIcon icon={faUndo} color="#1551d1e3" /></Button>
              </Nav.Item>
            </Nav>
          </Navbar.Collapse>
        </Navbar>
